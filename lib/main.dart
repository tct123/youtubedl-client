...
import 'package:youtubedlclient/download.dart';
import 'package:youtubedlclient/settings.dart';
...
class _YoutubedlGuiState extends State<YoutubedlGui> {
  ...
  void _startDownload() async {
    ...
    pendingList.forEach((pendingDownload) async {
      ...
      await _processDownload(pendingDownload.url, file);
  ...
  Future<void> _processDownload(String url, File file) async {
    // pass -k to keep original downloaded file
